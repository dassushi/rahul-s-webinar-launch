    ...
    <section className="py-20 relative">
      <div className="container">
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-gradient-to-br from-primary/10 via-card to-primary/5 border border-primary/30 rounded-3xl p-8 md:p-12 overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {bonuses.map((bonus, index) => (
                  <div
                    key={index}
                    className="bg-background/50 backdrop-blur-sm border border-border rounded-xl p-5 text-center hover:border-primary/50 transition-all duration-300"
                  >
